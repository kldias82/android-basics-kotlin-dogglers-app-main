...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.image_dog;
      ImageView imageDog = rootView.findViewById(id);
      if (imageDog == null) {
        break missingId;
      }
      ...
      id = R.id.text_dog_hobbie;
      TextView textDogHobbie = rootView.findViewById(id);
      if (textDogHobbie == null) {
        break missingId;
      }
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, imageDog,
          textDogAge, textDogHobbie, textDogName);
    }
